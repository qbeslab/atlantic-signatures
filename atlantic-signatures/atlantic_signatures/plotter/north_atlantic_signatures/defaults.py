...
from mycreate_plotter.config_loader import ureg
...
CONFIG_OPTIONS = {
    ...
    ('Boundary Conditions', 'xmin'): ('<quantity>', -2.7432 * ureg.meter, 'meter'),
    ('Boundary Conditions', 'xmax'): ('<quantity>', 2.7432 * ureg.meter, 'meter'),
    ('Boundary Conditions', 'ymin'): ('<quantity>', -2.7432 * ureg.meter, 'meter'),
    ('Boundary Conditions', 'ymax'): ('<quantity>', 2.7432 * ureg.meter, 'meter'),
